...
the KVM dongle is connected to on the back of the KVM switch.

A data sheet describing its functionality can be found
[here](https://lenovopress.com/tips0730).
 ...
 * Subnet 172.16.10.0/23
    * 172.16.10.2: [[moc-haas-master.bu.edu|PRB-MOC-Haas-Master-Config]]
    ...
    * 172.16.10.207: Red Hat Ceph Storage 3.0 ([details](Red-Hat-Ceph-3.0-cluster))
